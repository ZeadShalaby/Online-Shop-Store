						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>Zead Shalaby,software engineering</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>+201553068530</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>help.zeadshalaby1@gmail.com.com</a></li>
								</ul>
							</div>
						</div>
